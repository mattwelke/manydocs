...
func NewSaveAddedDocRef(db *sql.DB, addedDocRefsTableName string) func(docInsertPrimaryKeyEntries []saveddocrefs.DocInsertPrimaryKeyEntry) error {
	return func(docInsertPrimaryKeyEntries []saveddocrefs.DocInsertPrimaryKeyEntry) error {
