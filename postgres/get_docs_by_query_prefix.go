...
func NewGetDocsByQueryPrefix(db *sql.DB, docsByQueryPrefixTableName string) func(queryPrefix string) ([]map[string]interface{}, error) {
	return func(queryPrefix string) ([]map[string]interface{}, error) {
