...
func NewGetAddedDocRefs(db *sql.DB, addedDocRefsTableName string) func(docID string) ([]saveddocrefs.DocInsertPrimaryKeyEntry, error) {
	return func(docID string) ([]saveddocrefs.DocInsertPrimaryKeyEntry, error) {
